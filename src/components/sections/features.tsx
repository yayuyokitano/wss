			...
			<ul>
				<li>
					...
					<p>
						...
						<a href="https://libre.fm/" target="_blank" rel="noopener noreferrer">Libre.fm</a>, and 
				...
				<li>
					...
					<p>
						The 
						<a href="http://metadata-filter.vercel.app/" target="_blank" rel="noopener noreferrer">metadata filter</a>
						&nbsp;cleans track info up and removes redundant track suffixes.
					</p>
				</li>
				<li>
					<h3>Now Playing Notifications</h3>
					<p>Notifications of now playing tracks with extended track info (a website name, a track play count). Note: this does not currently work in Safari.</p>
				</li>
				<li>
				...
				<li>
					...
					<p>Available for Chrome, Chromium-based browsers (Opera, Vivaldi, etc), Firefox, and Safari (macOS and iOS).</p>
				</li>
				<li>
					<h3>Open Source & Ad-free</h3>
					<p>The extension is free for everyone and does not contain ads or banners.</p>
				</li>
			</ul>
		</section>
	)
